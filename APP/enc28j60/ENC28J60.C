...
void enc28j60Init(u8 * macaddr)
{
   ...
   // Type     ETH.DST
   // ARP      BROADCAST
   // 06 08 -- ff ff ff ff ff ff -> ip checksum for theses bytes=f7f9   //0x0806 ARP request 
   // in binary these poitions are:11 0000 0011 1111
   // This is hex 303F->EPMM0=0x3f,EPMM1=0x30
   enc28j60Write(ERXFCON, ERXFCON_UCEN | ERXFCON_CRCEN | ERXFCON_PMEN);   // 单播\CRC\格式匹配
   enc28j60Write(EPMM0, 0x3f);          //屏蔽字节
   enc28j60Write(EPMM1, 0x30);          
   enc28j60Write(EPMCSL, 0xf9);         //格式匹配校验和
